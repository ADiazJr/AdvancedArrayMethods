...
function problemTwo(){
    let results;
    userCuisine = prompt('What cuisine type would you like')
    results = dishes.filter(function(el){
...
let userInput = problemTwo();
console.log('userInput from problemTwo', userInput)
...
console.log('italianCuisine from problemThree', italianCuisine)
...
let idMatchCuisine = problemFour()
console.log('idMatchCuisine from problemFour', idMatchCuisine)
...
console.log('evenServings from problemFive', evenServings)
...
console.log('chickpeaDishes from problemSix', chickpeaDishes)
...
function problemSeven(){
    let results;
    userIngridient = prompt('What ingridient would you like your dish to have?')
    results = dishes.filter(function(el){
        if(el.ingredients.includes(userIngridient)){
            return true;
        }
        else{
            return false;
...
console.log('ingidientInput from problemSeven', ingredientInput)
...
cuisineStrings = problemEight()
console.log('cuisineStrings from problemEight', cuisineStrings)
...
cuisineTypeAndName = problemNine()
console.log('cuisineTypeAndName from problemNine', cuisineTypeAndName)
...
vegetarianNames = problemTen()
console.log('vegetarianNames from problemTen', vegetarianNames)
...
function problemEightB(){
    let results;
    results = cuisineStrings.filter(function(el, index){
        return cuisineStrings.indexOf(el) === index;
    });
    return results;
}
...
orProblem = problemEleven()
console.log('orProblem from problemEleven', orProblem)
...
totalCost = problemTwelve()
console.log('totalCost from problemTwelve', totalCost)
